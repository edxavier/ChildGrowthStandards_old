 ...
 */
public class WeightForHeight extends RealmObject {
    @Ignore
    ...
    public float getFifteen_girlsv() {
        return fifteen_girlsv;
    }

    public void setFifteen_girlsv(float fifteen_girlsv) {
        this.fifteen_girlsv = fifteen_girlsv;
    }
